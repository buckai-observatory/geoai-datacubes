...
- **26 missions** in a unified registry (v0.1.0; **+9 v0.2-preview additions on this branch** — Dynamic World, JRC GFC2020, NISAR L-band SAR, ArcticDEM v4.1, ICESat-2 ATL06, SWOT-HR, CryoSat-RDEFT4, GEDI L4B biomass, GEDI L4A biomass footprints — for 35 total). Sentinel-1 / 2, Landsat, NAIP, PlanetScope, MODIS, HLS, ALOS, Copernicus DEM, 3DEP, ESA WorldCover, JRC-GSW, USDA-CDL, Hansen-GFC, and more. Full per-mission band / resolution / value-range reference in [`docs/data_layers.md`](docs/data_layers.md).
