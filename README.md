...
Overview
The Sentinel Pipeline automates the entire workflow from raw satellite imagery to AI-ready datasets.
It supports both Sentinel-1 (SAR radar) and Sentinel-2 (optical) imagery.
Features
...
o	Left: Original NDVI
o	Middle: Cloud Mask (from SCL)
o	Right: NDVI after removing clouds
________________________________________
