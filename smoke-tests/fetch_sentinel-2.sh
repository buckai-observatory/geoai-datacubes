#!/bin/bash
#SBATCH --job-name=geoai-smoke-fetch-sentinel-2
...
# ---------------------------------------------------------------------------
# Smoke test: Sentinel-2 L2A surface reflectance via Earth Search.
#
...
# to smoke-tests/logs/fetch_sentinel-2.json so the run history can be committed.
# ---------------------------------------------------------------------------

# shellcheck source=_common.sh
source "$(dirname "${BASH_SOURCE[0]}")/_common.sh"

python smoke-tests/_run_fetch.py "Sentinel-2"
